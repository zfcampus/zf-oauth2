...
[create a proposal](https://github.com/zfcampus/zf-oauth2/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zfcampus/zf-oauth2.git
  $ cd zf-oauth2
  ```
...
2. Fork the repository (https://github.com/zfcampus/zf-oauth2)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zf-oauth2.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zf-oauth2.git
